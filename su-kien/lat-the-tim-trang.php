...
<!-- Mirrored from rongthansieucap.vn/su-kien/lat-the-tim-trang by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Nov 2025 05:23:01 GMT -->
...
<head>
    ...
    <meta property="og:image" content="../assets/frontend/events/vuitettrungthu2023/images/bns.jpg" />
    ...
    <link rel="stylesheet" href="../assets/frontend/events/vuitettrungthu2023/css/lib.css"/>
    <link rel="stylesheet" href="../assets/frontend/events/vuitettrungthu2023/css/style.css"/>  
    

    <script type="text/javascript" src="../assets/frontend/events/vuitettrungthu2023/js/jquery-3.6.4.min.js"></script>
    <script type="text/javascript" src="../assets/frontend/events/vuitettrungthu2023/js/lib.js"></script>
    </head>
...
<div class="main_head __zero">
    ...
    <div class="navbar">
        <div class="limit__game">
            ...
            <a href="../home.html" class=" hidden__mobile">
                <img src="../assets/frontend/events/vuitettrungthu2023/images/rtsc.png" alt="" class="logo-top">
            </a>
            <a href="../home.html" class=" hidden__mobile">
                <img src="../assets/frontend/events/vuitettrungthu2023/images/cbsc.png" alt="" class="logo-top">
            </a>
            ...
            <div class="left-header hidden__PC">
                ...
                <div class="icon-name-game dFlex ">
                    <div class="icon-game">
                        <img src="../assets/frontend/events/vuitettrungthu2023/images/banner1.png" alt="">
                        <img src="../assets/frontend/events/vuitettrungthu2023/images/rtsc.png" class="lgU__ic">
                    </div>
                    <div class="icon-game">
                        <img src="../assets/frontend/events/vuitettrungthu2023/images/banner2.png" alt="">
                        <img src="../assets/frontend/events/vuitettrungthu2023/images/cbsc.png" class="lgU__ic">
                    </div>
            ...
            <div class="dl__hbgsG dFlex aCenter jCenter">
                <div class="link-download tCenter hidden__PC btn-fls ac">
                    <a href="../download.html" class="a100 dFlex aCenter jCenter fRobotoM tUpper btYellow tCenter c-pointer tCenter ">
                        Tải game
                    </a>
                    <a target="_blank" href="https://pay.acegame.vn/game/db186" class="a100 dFlex aCenter jCenter fRobotoM tUpper tCenter btRed bd__red c-pointer tCenter ">
                        Nạp thẻ
                    </a>
                </div>
    ...
    <div class="limit__game">
        <div class="name__ev tCenter m__inline">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/textgame.png" class="">
        </div>

        <div class="card__com tCenter">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/come__on/card.png" class="hidden__PC caMB">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/come__on/card.png" class="hidden__mobile">
        </div>
...
<section class="st__ play__game __end p-r">
    ...
    <div class="top__fvip m__inline dFlex aCenter">
        <div class="cm__login c-page p-r dFlex">
                            <div class="btn__lrmhc m__inline dFlex aCenter jCenter btn__yl fRobotoB btYellow bd__red c-white c-pointer tCenter btn-tranY show__login">Đăng nhập</div>
                    </div>

        <div class="l_btn__tplg dFlex aCenter jCenter">
            <a target="_blank" href="../news/su-kien/trung-thu_52.html" class="btn__lrmhc dFlex aCenter jCenter fRobotoB btRed c-pointer tCenter btn-tranY show__rule__bk">Thể lệ</a>
            <div class="btn__lrmhc dFlex aCenter jCenter fRobotoB btRed c-pointer tCenter btn-tranY hidden__mobile show__mission">Nhận lượt</div>
            <div class="btn__lrmhc dFlex aCenter jCenter fRobotoB btRed c-pointer tCenter btn-tranY show__history">Lịch sử</div>
            <a target="_blank" href="https://pay.acegame.vn/game/db186" class="btn__lrmhc dFlex aCenter jCenter fRobotoB btRed c-pointer tCenter btn-tranY hidden__mobile">Nạp thẻ</a>
        </div>
    </div>


    <div class="ml__playGame  dFlex aCenter jCenter m__inline">

        <div class="flip-card card__playgame cpg1 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="imgBG__pLG">
                </div>
                <div class="flip-card-back p-a dFlex aCenter jCenter">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="imgBG__pLG">
                                    </div>
            </div>
        </div>

        <div class="flip-card card__playgame cpg2 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="imgBG__pLG">
                </div>
                <div class="flip-card-back p-a dFlex aCenter jCenter">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="imgBG__pLG">
                                    </div>
        ...
        <div class="flip-card card__playgame cpg3 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="imgBG__pLG">
        ...
        <div class="flip-card card__playgame cpg4 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="imgBG__pLG">
        ...
        <div class="flip-card card__playgame cpg5 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="imgBG__pLG">
        ...
        <div class="flip-card card__playgame cpg6 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png"  class="imgBG__pLG">
        ...
        <div class="flip-card card__playgame cpg7 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="imgBG__pLG">
        ...
        <div class="flip-card card__playgame cpg8 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png"  class="imgBG__pLG">
        ...
        <div class="flip-card card__playgame cpg9 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack2.png" class="imgBG__pLG">
        ...
        <div class="flip-card card__playgame cpg10 p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="bgIMG__hide imgBG__pLG" style="opacity: 0;">
            <div class="flip-card-inner p-a">
                <div class="flip-card-front">
                    <img src="../assets/frontend/events/vuitettrungthu2023/images/play__game/imgBack1.png" class="imgBG__pLG">
    ...
    <div class="handle__radar dFlex aCenter jCenter">
        <div class="btn__hd_rd btBlue fRobotoB c-white c-pointer tCenter btn-tranY hidden__PC show__mission">Nhận lượt</div>
        <div class="btn__hd_rd btYellow fRobotoB  c-pointer tCenter btn-tranY" onclick="truytimAjx('x1');">Lật Thẻ 1 lần</div>
        <div class="btn__hd_rd btRed fRobotoB c-pointer tCenter btn-tranY" onclick="truytimAjx('x10');">Lật Thẻ 10 lần</div>
    </div>

</section><section class="st__ make__cake __2">

    <div class="title__frame red m__inline tCenter">
        <div class="name__titf fmarlon" style="font-size: clamp(26px, 5vw, 52px);">Làm Bánh Vui Vẻ - Đổi Quà Thả Ga</div>
        <img src="../assets/frontend/events/vuitettrungthu2023/images/rauRed.png" style="width:60%;max-width: 520px;">
    </div>

    <div class="tCenter">
        <a href="javascript:;" class="all__num__ofmy cRed show__rule">
            Hướng Dẫn Đổi Quà Chi Tiết
        </a>
    </div>

    <div class="men__psnl men__psnl1 custom__ar dFlex aCenter jCenter m__inline mainShop">
    </div>

</section><section class="st__ personal__ __end">
    <div class="title__frame yl m__inline tCenter">
        <div class="name__titf fmarlon" style="font-size: clamp(26px, 5vw, 52px);"><div>Tích Lũy Mặt Trăng</div> <span>-</span> <div>Nhận Quà Siêu Cấp</div></div>
        <img src="../assets/frontend/events/vuitettrungthu2023/images/rauYellow.png" style="width:60%;max-width: 520px;">
    </div>

    <div class="tCenter">
        <div class="all__num__ofmy c-page2">
            Tổng Mặt Trăng của bạn: <span class="c-orange fRobotoB user-scoretotal">0</span>
        </div>
    </div>


    <div class="men__psnl men__psnl2 custom__ar dFlex aCenter jCenter m__inline quaCaNhan">
...
<div class="footer-ace  footer__game __end tUpper p-r">
    ...
    <div class="max_rank">
        ...
        <div class="footer-ace-inner" itemscope="" itemtype="http://schema.org/Organization">
            ...
            <img src="../assets/frontend/events/vuitettrungthu2023/images/undo18.png" width="70" height="101" class="footer-ace-18">
        </div>
    </div>
</div>
...
<div class="sidebar_right hidden__mobile mo ">
    ...
    <div class="sidebar_right-content tCenter">
        <img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/qr.png" alt="" class="icon-right">

        <div class="tCenter t-lineok">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/line.png" alt="" class="line">
        </div>
        <div class="tCenter fRobotoM t-dks c-white">
            Tải game ngay tại
        </div>

        <a href="https://apps.apple.com/vn/app/id6446673495?l=vi" class="link-dlgame img-hv p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/ios.png" alt="" class="img-bt">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/ios-hv.png" alt="" class="img-hv p-a in-img-hv">
        </a>

        <a href="https://play.google.com/store/apps/details?id=com.rtsc.ultracombo" class="link-dlgame linkdks-android img-hv p-r">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/android.png" alt="" class="img-bt">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/android-hv.png" alt="" class="img-hv p-a in-img-hv">
        </a>
        ...
        <div class="go-top">
            <img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/top.png" alt="">
        </div>
    </div>
    <span class="dieu_khien dFlex aCenter jCenter dieu_khien-mo">
		<img src="../assets/frontend/events/vuitettrungthu2023/images/sibarRight/img-arrow.png" class="imgCtr">
	</span>
</div>
...
<div class="modal" id="modal__login" style="display: none;">
    <div class="content-modal p-r">
        <div class="wrapper-modal">
            ...
            <div class="title-modal tCenter tUpper fmarlon">
                <div class="name__tit">đăng nhập</div>
                <img src="../assets/frontend/events/vuitettrungthu2023/images/modal/img__bt_tit.png" class="imgStarTp">
            </div>
                ...
                <div>
                    ...
                    <div class="other-login tct dFlex aCenter jCenter tUpper">
                        <a href="javascript:;" data-href="https://id.acegame.vn/Oauth?partner=google&amp;Returnurl=https%3A%2F%2Frongthansieucap.vn%2Fauth%2Fopenid-oauth" class="btn-openid-login login-gg dFlex aCenter jCenter">
                            <img src="../assets/frontend/events/vuitettrungthu2023/images/modal/img-gg.png" alt="" />
                        </a>
                        <a href="javascript:;" data-href="https://id.acegame.vn/Oauth?partner=facebook&amp;Returnurl=https%3A%2F%2Frongthansieucap.vn%2Fauth%2Fopenid-oauth" class="btn-openid-login login-fb2 dFlex aCenter jCenter">
                            <img src="../assets/frontend/events/vuitettrungthu2023/images/modal/img-fb.png" alt="" />
                        </a>
                    </div>
                </div>
            </div>
...
<div class="modal" id="modal__server" style="display: none;">

    <div class="content-modal p-r">
        <div class="wrapper-modal">

            <div class="title-modal tCenter tUpper fmarlon">
                <div class="name__tit">chọn máy chủ</div>
                <img src="../assets/frontend/events/vuitettrungthu2023/images/modal/img__bt_tit.png" class="imgStarTp">
            </div>

            <div class="main-mdl_gm mt-3per">
                <div class="note note-hello m__inline">
                    <p>Xin chào, <span class="cRed">hoanganhprofess</span></p>
                    <p>Vui lòng chọn máy chủ và nhân vật</p>
                </div>
                <form action="#">
                    <div class="form-control m__inline box-input tCenter mt-3per">
                        <select name="" id="">
                            <option value="0">Vui lòng chọn server</option>
                            <option value="0">S1 - Pro</option>
                            <option value="0">S2 - Vip</option>
                            <option value="0">S3 - Amater</option>
                        </select>
                    </div>
                    <div class="form-control m__inline box-input tCenter mt-3per">
                        <select name="" id="">
                            <option value="0">Vui lòng chọn nhân vật</option>
                            <option value="0">S1 - Pro</option>
                            <option value="0">S2 - Vip</option>
                            <option value="0">S3 - Amater</option>
                        </select>
                    ...
                    <div class="tCenter mt-3per">
                        <button type="submit" class="btn-log btRed fRobotoB c-pointer tUpper tCenter btn-tranY">Xác nhận</button>
                    </div>
    ...
    <div class="content-modal">
        <div class="wrapper-modal">
            ...
            <div class="main-modal m__inline tCenter mt-3per">
                <div class="helloUser tCenter alert">Chúc mừng bạn đã nhận được</div>
...
<script>
        ...
        $.post(
            ...
            response => {
                if (response.status == 1) {
                    window.location.href = "lat-the-tim-trang.html";
                } else {
    ...
    var popupOpenIdLoginSuccess = function () {
        if(window.opener) {
                        window.opener.location.href = 'lat-the-tim-trang.html';
                        window.close();
        } else {
                        window.location.href = 'lat-the-tim-trang.html';
                    }
    ...
    var chooseServer = function(){
        ...
        $.get('lat-the-tim-trang/chon-nhan-vat.html', resp => {
            $('body').append(resp);
    ...
    var getHistory = function (code, page = 1) {
        ...
        $.get('https://rongthansieucap.vn/su-kien/lat-the-tim-trang/lich-su/'+code+'?p='+page, response => {
    ...
    var getMission = function () {
        ...
        $.get('lat-the-tim-trang/nhiem-vu.html', response => {
            $('body').append(response);
            $('#modal__mission').show();
        });
    }
    var getRule = function () {
        $('#modal__rule').remove();
        $.get('lat-the-tim-trang/rule.html', response => {
            $('body').append(response);
            $('#modal__rule').show();
        });
    }
    ...
    var getUserInfo = function () {
        $.get('lat-the-tim-trang/user-info.json', response => {
            if(response) {
                $('.user-used').text(response.used);
                $('.user-turn').text(response.turn);
                $('.user-score').text(response.score);
                $('.user-scoretotal').text(response.score);
            }
        }, 'json');
    }

    var loadGiftPieceForUser = function () {
        $.get('lat-the-tim-trang/qua-ghepmanh.html', response => {
    ...
    var loadGiftForUser = function () {
        $.get('lat-the-tim-trang/qua-ca-nhan.html', response => {
    ...
    var nhanQuaGhepManh = function (pack_code) {
        $.post('https://rongthansieucap.vn/su-kien/lat-the-tim-trang/nhan-qua-ghepmanh/' + pack_code, response => {
            if(response.status == 1) {
                loadGiftPieceForUser();
            }
    ...
    var nhanQuaCaNhan = function (giftCode) {
        $.post('https://rongthansieucap.vn/su-kien/lat-the-tim-trang/nhan-qua-ca-nhan/'+giftCode, response => {
            if(response.status == 1) {
                loadGiftForUser();
            }
            customAlert(response.message);
...
<script>
    ...
    var truytimAjx = function (turn) {
        ...
        if(isStart) {
            ...
            $.get('https://rongthansieucap.vn/su-kien/lat-the-tim-trang/lat-the/' + turn, response => {
                if(response.status == 1) {
                    let html_show_quay = '';
                    if(response.data && response.data.length > 0){
                        for(var i = 0; i < response.data.length; i++) {
                            ...
                            if(response.data[i]['image'] == null){
                                html_show_quay += `<img src="/assets/frontend/events/vuitettrungthu2023/images/demo.png" alt="">`;
                            } else {
                                html_show_quay += `<img src="/assets/frontend/events/vuitettrungthu2023/images/omg/`+response.data[i]['image']+`" alt="">`;
                            }
...
<script>
    $(document).ready(function () {
        $("body").on("click", ".close_modal, .btn__close", function () {
            ...
            $('.card__playgame').removeClass('active')
        });
...
<!-- Mirrored from rongthansieucap.vn/su-kien/lat-the-tim-trang by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Nov 2025 05:23:09 GMT -->
</html>
