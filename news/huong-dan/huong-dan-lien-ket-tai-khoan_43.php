...
<!-- Mirrored from rongthansieucap.vn/news/huong-dan/huong-dan-lien-ket-tai-khoan_43 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Nov 2025 05:21:13 GMT -->
			...
			<div class="limit__game">
				<ul class="breadcrumb p-r" data-aos="fade-up" data-aos-duration="700" data-aos-delay="700">
					<li class="current"><a href="../../home.php">Trang chủ</a></li>
										<li><span>Hướng Dẫn Liên Kết Tài Khoản</span></li>
				</ul>
				<div class="main-content-news" data-aos="fade-up" data-aos-duration="700" data-aos-delay="1000">
					<div class="title-main-new">
						<div class="title-left"><span class="f-tahomabold"></span> Hướng Dẫn Liên Kết Tài Khoản</div>
						<div class="date-open-right  hidden-mobile">18/07/2023</div>
					</div>

					<div class="text-detail detail-post">
						<p>&nbsp; &nbsp;C&aacute;c Chiến Binh&nbsp;th&acirc;n mến,</p>

<p>&nbsp; &nbsp; &nbsp;Đăng nhập bằng Facebook v&agrave; Google l&agrave; hai sự lựa chọn nhanh nhất để v&agrave;o game, tuy nhi&ecirc;n việc đăng nhập bằng c&aacute;ch n&agrave;y sẽ gặp một số rủi ro nhất định về việc nạp thẻ hoặc bị kh&oacute;a Facebook th&igrave; sẽ kh&ocirc;ng thể đăng nhập v&agrave;o game.</p>

<p>&nbsp; &nbsp; &nbsp;Bulma xin hướng dẫn c&aacute;c chiến binh&nbsp;c&aacute;ch thức li&ecirc;n kết t&agrave;i khoản Facebook v&agrave; G+ để mọi người được hỗ trợ tốt nhất nếu như c&oacute; vấn đề ph&aacute;t sinh li&ecirc;n quan đến t&agrave;i khoản.</p>

<p><strong><span style="color:#FF0000">◈&nbsp;&nbsp;Đối với t&agrave;i khoản Facebook</span></strong></p>

<p><span style="color:#FF0000"><strong>Bước 1:</strong></span> Đăng nhập trang https://id.acegame.vn/ bằng t&agrave;i khoản Facebook (Lấy th&ocirc;ng tin ID khi đăng nhập bằng FB)</p>

<p>&nbsp;ID ACE GAME chuyển từ FB sang c&oacute; dạng: fb.********* &nbsp;(*** = t&ecirc;n đăng nhập facebook của bạn)</p>

<p>&nbsp; &nbsp; &nbsp; Lưu lại th&ocirc;ng tin ID Facebook (Cập nhật đầy đủ c&aacute;c th&ocirc;ng tin đăng k&iacute; t&agrave;i khoản như Email,CMND, c&acirc;u hỏi v&agrave; c&acirc;u trả lời bảo mật tại mục Th&ocirc;ng tin t&agrave;i khoản tr&ecirc;n cổng ID).</p>

<p style="text-align:center"><img alt="" src="../../uploads/lienket10.png" /></p>

<p>Lưu &yacute;: Bắt buộc phải thao t&aacute;c cập nhật Email&nbsp;v&agrave; k&iacute;ch hoạt để tiến h&agrave;nh lấy mật khẩu t&agrave;i khoản v&agrave;o game.</p>

<p style="text-align:center"><img alt="" src="../../uploads/lienket2.png" /></p>

<p>&nbsp; &nbsp; &nbsp;Sau khi cập nhật đầy đủ th&ocirc;ng tin bạn&nbsp;bấm Tho&aacute;t trở về giao diện đăng nhập sử dụng t&iacute;nh năng &ldquo;Qu&ecirc;n Mật Khẩu&rdquo; yes</p>

<p style="text-align:center"><img alt="" src="../../uploads/lienket3.png" /></p>

<p>&nbsp;</p>

<p><span style="color:#FF0000"><strong>Bước 2:</strong></span> Đăng nhập Email đ&atilde; đăng k&yacute; t&agrave;i khoản để lấy Mật khẩu mới</p>

<p style="text-align:center"><img alt="" src="../../uploads/lienket5.png" /></p>

<p>Lưu &yacute; cần nhấn v&agrave;o n&uacute;t &quot;TẠI Đ&Acirc;Y&quot; để x&aacute;c nhận mật khẩu mới. Sau khi nhấn hiển thị th&ocirc;ng b&aacute;o như h&igrave;nh l&agrave; th&agrave;nh c&ocirc;ng</p>

<p style="text-align:center"><img alt="" src="../../uploads/lienket6.png" /></p>

<p>Sau khi k&iacute;ch hoạt mật khẩu th&agrave;nh c&ocirc;ng bạn c&oacute; thể sử dụng Mật khẩu v&agrave; ID Facebook để đăng nhập v&agrave;o game như b&igrave;nh thường.</p>

<p>Bạn&nbsp;c&oacute; thể đổi lại mật khẩu theo &yacute; muốn để dễ d&agrave;ng ghi nhớ.</p>

<p style="text-align:center"><img alt="" src="../../uploads/lienket7.png" /></p>

<p>&nbsp; &nbsp; &nbsp;Lưu &yacute;:</p>

<p>&nbsp; &nbsp; &nbsp;Kể từ sau khi đăng k&iacute; t&agrave;i khoản ID ACE bằng FB th&agrave;nh c&ocirc;ng, cả FB v&agrave; ID ACE của bạn đều v&agrave;o được t&agrave;i khoản game.</p>

<p>&nbsp; &nbsp; &nbsp;Bạn ch&uacute; &yacute; kh&ocirc;ng chia sẻ nick FB cũng như t&agrave;i khoản ID ACE của m&igrave;nh để tr&aacute;nh t&igrave;nh trạng bị kẻ gian hack t&agrave;i khoản nh&eacute;.</p>

<p>&nbsp;</p>

<p><span style="color:#FF0000"><strong>◈&nbsp;Đối với t&agrave;i khoản Google+</strong></span></p>

<p><span style="color:#FF0000"><strong>Bước 1: </strong></span>Đăng nhập trang https://id.acegame.vn/ bằng t&agrave;i khoản Google+ (Gmail)</p>

<p style="text-align:center"><img alt="" src="../../uploads/lienket11.png" /></p>

<p>&nbsp;Lưu &yacute;: Bắt buộc bạn phải thao t&aacute;c cập nhật th&ocirc;ng tin t&agrave;i khoản Email&nbsp;v&agrave; k&iacute;ch hoạt để tiến h&agrave;nh lấy mật khẩu t&agrave;i khoản v&agrave;o game</p>

<p>&nbsp; &nbsp; &nbsp; Khi đ&oacute; Gmail của bạn&nbsp;trở th&agrave;nh ID ACE, nhưng l&uacute;c n&agrave;y bạn kh&ocirc;ng đổi được mật khẩu v&igrave; mật khẩu Gmail kh&ocirc;ng t&iacute;ch hợp với ID.</p>

<p>&nbsp; &nbsp; &nbsp; Bạn cần thao t&aacute;c lấy lại mật khẩu tương tự như với Facebook.</p>

<p><span style="color:#FF0000"><strong>Bước 2:</strong></span> Thao t&aacute;c &ldquo;Qu&ecirc;n mật khẩu&rdquo; tại https://id.acegame.vn/&nbsp;</p>

<p><span style="color:#FF0000"><strong>Bước 3: </strong></span>Đăng nhập Gmail để k&iacute;ch hoạt mật khẩu mới.</p>

<p>&nbsp; &nbsp; &nbsp; &nbsp; Vậy l&agrave; Gmail của bạn đ&atilde; ch&iacute;nh thức trở th&agrave;nh ID ACE, bạn ho&agrave;n to&agrave;n c&oacute; thể đăng nhập game bằng ID v&agrave; mật khẩu mới m&agrave; kh&ocirc;ng cần đăng nhập Gmail nữa.</p>

<p>&nbsp; &nbsp; &nbsp; &nbsp; Đăng nhập https://id.acegame.vn/ để cập nhật c&aacute;c th&ocirc;ng tin bảo mật cho t&agrave;i khoản (Email, CMND,&nbsp;c&acirc;u hỏi v&agrave; c&acirc;u bảo mật) v&agrave; c&aacute;c thao t&aacute;c quan trọng kh&aacute;c.</p>
...
<!-- Mirrored from rongthansieucap.vn/news/huong-dan/huong-dan-lien-ket-tai-khoan_43 by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 27 Nov 2025 05:21:15 GMT -->
</html>
