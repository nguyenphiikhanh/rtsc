    ...
    <div class="main__news">
        <div class="limit__game">
            <ul class="breadcrumb p-r" data-aos="fade-up" data-aos-duration="700" data-aos-delay="700">
                ...
                <li class=""><span></span></li>
                <li class=""><span></span></li>
                <li class="current"><span>Hướng dẫn</span></li>
            </ul>
            <div class="main-content-news" data-aos="fade-up" data-aos-duration="700" data-aos-delay="1000">
                <div class="title-main-new">
                    <div class="title-left"><span class="f-tahomabold">[Tin tức hướng dẫn]</span></div>
                </div>
                ...
                <div class="list-new-page">
                    ...
                    <div class="item-new clearfix item-tranYTop">
                        ...
                        <a href="<?= define_url("news/huong-dan/tong-hop-trang-bi.php") ?>" class="a100">
                            <div class="thumb f-left">
                                <img src="<?= define_url("assets/frontend/home/v1/images/img-huong-dan.png")?>" alt="thumb">
                            </div>
                            <div class="full-text f-left">
                                <div class="title-new-date clearfix">
                                    <h2 class="title-new f-left"><span class="f-tahomabold">[Hướng Dẫn]</span> Tổng Hợp Về
                                        Trang Bị</h2>
                    ...
                    <div class="item-new clearfix item-tranYTop">
                        ...
                        <a href="<?= define_url("news/huong-dan/ho-tro-nhiem-vu.php") ?>" class="a100">
                            <div class="thumb f-left">
                                <img src="<?= define_url("assets/frontend/home/v1/images/img-huong-dan.png")?>" alt="thumb">
                            </div>
                            <div class="full-text f-left">
                                <div class="title-new-date clearfix">
                                    <h2 class="title-new f-left"><span class="f-tahomabold">[Hướng Dẫn]</span> Hỗ Trợ
                                        Nhiệm Vụ</h2>
                                    <div class="date-open f-right hidden-mobile">14/12</div>
                                </div>
                                <div class="des-text"></div>
