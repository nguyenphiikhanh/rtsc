    ...
    <div class="main__news">
        <div class="limit__game">
            <ul class="breadcrumb p-r" data-aos="fade-up" data-aos-duration="700" data-aos-delay="700">
                ...
                <li class="current"><span>Tin tức</span></li>
                <li class=""><span></span></li>
                <li class=""><span></span></li>
                <li class=""><span></span></li>
            </ul>
            <div class="main-content-news" data-aos="fade-up" data-aos-duration="700" data-aos-delay="1000">
                ...
                <div class="list-new-page">
                    ...
                    <div class="item-new clearfix item-tranYTop">
                        ...
                        <a href="<?= define_url("news/tin-tuc/thong-tin-quan-trong.php") ?>" class="a100">
                            <div class="thumb f-left">
                                <img src="<?= define_url("assets/frontend/home/v1/images/img-tin-tuc.png") ?>"
                                     alt="thumb">
                            </div>
                            <div class="full-text f-left">
                                <div class="title-new-date clearfix">
                                    <h2 class="title-new f-left"><span class="f-tahomabold">[Tin Tức]</span> THÔNG TIN
                                        QUAN TRỌNG</h2>
                    ...
                    <div class="item-new clearfix item-tranYTop">
                        ...
                        <a href="<?= define_url("news/tin-tuc/thong-tin-server.php") ?>" class="a100">
                            <div class="thumb f-left">
                                <img src="<?= define_url("assets/frontend/home/v1/images/img-tin-tuc.png") ?>" alt="thumb">
                            </div>
                            <div class="full-text f-left">
                                <div class="title-new-date clearfix">
                                    <h2 class="title-new f-left"><span class="f-tahomabold">[Tin Tức]</span> [UPDATE]
                                        THÔNG TIN CHI TIẾT SEVER</h2>
                                    <div class="date-open f-right hidden-mobile">14/12</div>
                                </div>
                                <div class="des-text"></div>
                            </div>
                    ...
                    <div class="item-new clearfix item-tranYTop">
                        ...
                        <a href="<?= define_url("news/tin-tuc/update-tinh-nang.php")?>"
                           class="a100">
                            <div class="thumb f-left">
                                <img src="<?= define_url("assets/frontend/home/v1/images/img-tin-tuc.png") ?>" alt="thumb">
                            </div>
